...
RSpec.describe UserRepository do
  ...
  context 'CREATE' do
    it 'adds a new user to database' do
      ...
      user = double name: 'Mike', username: 'mike', email: 'mike@mike.com',
                    password: '$2a$12$RWbFtjHnA3kC2Gt31m7/l.N4f8ISipDp9T7KIyvSHhww/sGqohGHS'
      response = repo.create(user)
      entry = response.first
      expect(entry['id'].to_i).to eq 4
